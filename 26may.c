//Q1. Write a C program to get the indices of two numbers in a given array of integers. This will enable you to get the sum of two numbers equal to a specific target. Expected output.original array:4 2 1 5 target value 7. indices of the two number whose sum equal to target value: 7 1 
#include <stdio.h>
#include <stdlib.h>
